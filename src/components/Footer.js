            ...
            <Col lg={4} md={6} className="mb-4">
              <div className="footer-brand">
                ...
                <p className="brand-description">
                  Empowering entrepreneurs and fostering innovation at
                  Cooch Behar Government Engineering College.
                  Join us in building the next generation of tech leaders
                  and innovators.
                </p>
                ...
                <div className="contact-item">
                  ...
                  <span>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      href="https://maps.google.com/?q=Cooch+Behar+Government+Engineering+College"
                    >
                      Cooch Behar Government Engineering College,
                      West Bengal, India
                    </a>
          ...
          <Row className="align-items-center">
            ...
            >
              <p className="mb-0 copyright-text">
                &copy; {new Date().getFullYear()} CGEC E-CELL.
                All rights reserved.
              </p>
            </Col>
